import numpy as np
from three.core import Uniform, RenderTarget
from three.cameras import ShadowCamera
from three.lights import Light
from three.material import ShadowMaterial
